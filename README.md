### Домашнее задание для курсов DA

В этом репозитории собраны ответы на домашние задания по курсу "Python для анализа данных".

Список сданных работ:
- [Тема 1. Основы Python](data/homework/HW1.ipynb)
- [Тема 2. Управляющие конструкции и коллекции. Часть 1](data/homework/HW2.ipynb)
